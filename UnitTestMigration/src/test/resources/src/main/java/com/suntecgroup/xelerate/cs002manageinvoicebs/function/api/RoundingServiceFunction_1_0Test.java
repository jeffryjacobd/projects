...
public class RoundingServiceFunction_1_0Test extends AbstractTestNGSpringContextTests {
    ...
    @ComponentScan(basePackages = {"com.suntecgroup.xelerate.sunrise.bs.common", "com.suntecgroup.xelerate.sunrise.common",
            "com.suntecgroup.xelerate.cs002managecurrencybs.*"})
    ...
    @Autowired
    @Qualifier("cS002ManageCurrencyBS/roundingService_1.0")
    @BeforeClass
    void setup() {
    ...
    private void preparePlatformMocks() {
        Mockito.when(service2.getVersion(Mockito.anyString(),
